...
touch ref.txt
cols=("Assembly" "# contigs (>= 0 bp)" "# contigs (>= 1000 bp)" "Total length (>= 0 bp)" "Total length (>= 1000 bp)" "# contigs  " \
	"Total length  " "Largest contig"  "Reference length" "GC (%)" "Reference GC (%)" "N50" "NG50" "N75" "L50" "LG50" "L75" \
	"# misassemblies" "# misassembled contigs" "Misassembled contigs length" "# local misassemblies" "# unaligned contigs" "Unaligned length" "Genome fraction" \
